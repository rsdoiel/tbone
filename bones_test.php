...
$attr = assemble_attributes(array('class' => 'myclass'));
$assert->equal($attr, ' class="myclass"', 'Should have class="myclass" [' . $attr . '] from assoc. array');
$attr = assemble_attributes(array('checked' => NULL, 'id' => 'mything'));
...
$str = ' one="1" two="2"';
$attributes = attributes_string_to_array($str);
