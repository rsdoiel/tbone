...
(function (global, exports) {
	...
	CSS.prototype.as = function (collection, filename) {
		throw "CSS.as() not implemented.";
	};

	CSS.prototype.include = function (collection, source_code) {
		throw "CSS.include() not implemented.";
	};

	CSS.prototype.inline = function (collection, options) {
	...
	JS.prototype.as = function (collection, filename) {
		throw "JS.as() not implemented.";
	};

	JS.prototype.include = function (collection, source_code) {
		throw "JS.include() not implemented.";
	};

	JS.prototype.inline = function (collection, options) {
